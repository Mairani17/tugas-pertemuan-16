package com.informatika19100092databarang.adapter
...
import com.informatika19100092databarang.R
import com.informatika19100092databarang.UpdateDataActivity
import com.informatika19100092databarang.model.DataItem
...
class ListContent (val ldata: List<DataItem?>?, val context: Context):
    ...
    class ViewHolder(val view : View)  : RecyclerView.ViewHolder(view){
        ...
        val delectBarang = view.findViewById<TextView>(R.id.tv_delete)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.delectBarang.setOnClickListener {
